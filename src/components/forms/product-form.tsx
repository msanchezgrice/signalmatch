...
export function ProductForm() {
  ...
  async function runAnalyzer() {
    ...
    try {
      ...
      if (
        !form.getValues("category_tags_csv") &&
        parsed.category_tags.length > 0
      ) {
  ...
  async function onSubmit(data: FormData) {
    try {
      ...
      capture("product_created", { productId: json.product.id });
      ...
      {step === 1 ? (
        <div className="space-y-4">
            ...
            <label className="mb-1 flex items-center gap-1.5 text-sm font-medium">
              ...
              <Tooltip>
                ...
                <TooltipContent className="max-w-xs">
                  We use this to extract headline messaging, features, and
          ...
          {analysis ? (
            <Card className="app-surface">
              ...
              <CardContent className="app-muted-text space-y-3 text-sm">
                <div>
                  <p className="app-strong-text font-medium">
                    Suggested summary
                  </p>
                  <p>{analysis.summary || "No summary extracted."}</p>
                </div>
                <div>
                  <p className="app-strong-text font-medium">Core points</p>
                ...
                <div>
                  <p className="app-strong-text font-medium">Target personas</p>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              className="app-surface w-full rounded-md border p-2 text-sm"
